...
== 9.15.1 P16 (22. Dezember 2025)

Der Patch 9.15.1 P16 ist jetzt für Cloud Volumes ONTAP für alle Cloud-Anbieter verfügbar. Die Konsole fordert Sie auf, Ihre vorhandenen Systeme auf diese Patch-Version zu aktualisieren.

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P16["Sehen Sie sich die Liste der im P16-Patch behobenen Fehler an."^](Anmeldung auf der NetApp Support-Site erforderlich).



== 9.15.1 P15 (24. Oktober 2025)

Der Patch 9.15.1 P15 ist jetzt für Cloud Volumes ONTAP für alle Cloud-Anbieter verfügbar. Die Konsole fordert Sie auf, Ihre vorhandenen Systeme auf diese Patch-Version zu aktualisieren.

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P15["Sehen Sie sich die Liste der im P15-Patch behobenen Fehler an"^](Anmeldung auf der NetApp Support-Site erforderlich).



== 9.15.1 P14 (09. Oktober 2025)

Der Patch 9.15.1 P14 ist jetzt für Cloud Volumes ONTAP für alle Cloud-Anbieter verfügbar. Die Konsole fordert Sie auf, Ihre vorhandenen Systeme auf diese Patch-Version zu aktualisieren.

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P14["Sehen Sie sich die Liste der im P14-Patch behobenen Fehler an"^] (Anmeldung auf der NetApp Support-Site erforderlich).



== 9.15.1 P13 (09. Oktober 2025)

Der Patch 9.15.1 P13 ist jetzt für Cloud Volumes ONTAP für alle Cloud-Anbieter verfügbar. Die Konsole fordert Sie auf, Ihre vorhandenen Systeme auf diese Patch-Version zu aktualisieren.

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P13["Sehen Sie sich die Liste der im P13-Patch behobenen Fehler an"^] (Anmeldung auf der NetApp Support-Site erforderlich).



== 9.15.1 P12 (22. August 2025)

Der Patch 9.15.1 P12 ist jetzt für Cloud Volumes ONTAP für alle Cloud-Anbieter verfügbar. BlueXP fordert Sie auf, Ihre vorhandenen Systeme auf diese Patch-Version zu aktualisieren.

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P12["Sehen Sie sich die Liste der im P12-Patch behobenen Fehler an"^] (Anmeldung auf der NetApp Support-Site erforderlich).



== 9.15.1 P11 (04. Juli 2025)
