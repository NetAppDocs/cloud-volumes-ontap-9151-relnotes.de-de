...
Der Patch 9.15.1 P14 ist jetzt für Cloud Volumes ONTAP für alle Cloud-Anbieter verfügbar. Die NetApp Console fordert Sie auf, Ihre vorhandenen Systeme auf diese Patch-Version zu aktualisieren.
...
Der Patch 9.15.1 P13 ist jetzt für Cloud Volumes ONTAP für alle Cloud-Anbieter verfügbar. Die NetApp Console fordert Sie auf, Ihre vorhandenen Systeme auf diese Patch-Version zu aktualisieren.
